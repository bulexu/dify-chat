...
# 替换环境变量
sed -i "s|{{__PUBLIC_APP_API_BASE__}}|$PUBLIC_APP_API_BASE|g" /usr/share/nginx/html/chat/env.js
sed -i "s|{{__PUBLIC_DIFY_PROXY_API_BASE__}}|$PUBLIC_DIFY_PROXY_API_BASE|g" /usr/share/nginx/html/chat/env.js
sed -i "s|{{__PUBLIC_DEBUG_MODE__}}|$PUBLIC_DEBUG_MODE|g" /usr/share/nginx/html/chat/env.js
